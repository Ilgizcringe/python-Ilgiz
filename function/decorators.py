...
#     func()
#     end = time.time()
#     print(f'Время выполнения функции {func.name} {end-start}')
...
#     def wrapper(list1_):
#         a = [f'+996 {num[1:4] + " " + num[4::]}' for num in list1_]
#         func(a)
#     return wrapper

# @get_full_number
# def sort_phone_nums(list_:list):
#     list_.sort()
#     str_ = '#'.join(list_)
#     print(str_)
