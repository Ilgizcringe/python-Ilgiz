...
# хотя бы одна часть выражения должна быть True -> False
...
# if условие1
#    тело1
    # тело1 будет выполняться, если условие1 верно (True)
...
# else:
#     тело2
#     # тело2 будет выполнятьсяб если в условие1 не верно (True) (во всех остальных случаях)
...
# elif условиу2:
#     тело2
     # тело2 будет выполняться если в условие1 не верно (True) а в условие2 верно
...
# else:
    # тело3
    # тело3 будет выполняться, если условие1 и условие2 не верны (True)
...
# a = int(input('Введите чсило от 1 до 5: '))
...
=================== Маржовый оператор =========================
'''
# := -> позволяет присвоить значение переменной и вернуть её
# print(num1 = 2) # = только присваивает, но не возвращает (ошибка)
# print(num2 := 4)

count = 0 
number = input('Введите слово: ') 
if number.isdigit(): 
    number = int(number) 
    count = number 
print(count)