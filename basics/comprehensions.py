...
==================== list comprehension ====================
''' 
# упрощённый подход к созданию списков с использованием цикла for, а также if-else
...
'''
если в comprehension используем is-else, то указываются в самом начале (результат)
...
========================== Set comprehension ===========================
'''
# почти тоже самое что и list comprehension, только элементы не дублируются и не сохраняется порядок, используются {}
